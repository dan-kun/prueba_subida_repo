create or replace package body OMPROD.om_pack_order_administration AS
  ...
  PROCEDURE get_batch_simswap_delay (               v_data_simswap_delay out sys_refcursor,
    ...
    BEGIN
      ...
      exception
        when no_data_found then
          error_id    := -50000;
          error_descr := '[om_pack_order_administration_2.get_batch_simswap_delay]';
        when others then
          error_id    := -50000;
          error_descr := '[om_pack_order_administration_2.get_batch_simswap_delay]';
...
--                END IF;
  ...
  --            -- CREAR REGISTROS PARA LOS PROCESOS
    ...
    EXCEPTION
      WHEN Others THEN
        error_id    := SQLCODE;
        error_descr := '[om_pack_order_administration.create_order_batch] ' || SQLERRM;
